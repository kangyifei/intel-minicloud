...
class GBRT(object):
    ...
    def __init__(self, n_trees):
        ...
        x = []
        y = []
        for timenode in range(0, 300, 5):
            x.append(timenode)
            y.append(10)
        for timenode in range(300, 600, 5):
            x.append(timenode)
            y.append(100)
...
if __name__ == '__main__':
    ...
    # print(time.time())
    print(type(model.predict([100001, 100002, 100003, 100004, 100005, 100006],600).tolist()))
    print(model.predict([120001, 120002, 120003, 120004, 120005, 120006],600))
    # print(time.time())
